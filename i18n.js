...
const LANGS = {
  uz: {
    ...
    loginTitle: 'Namangan Ijara', loginDesc: 'Davom etish uchun Telegram akkauntingiz bilan kiring',
  ...
  ru: {
    ...
    loginTitle: 'Namangan Ijara', loginDesc: 'Войдите через ваш аккаунт Telegram',
  ...
  en: {
    ...
    loginTitle: 'Namangan Ijara', loginDesc: 'Sign in with your Telegram account to continue',
