...
const LANGS = {
  uz: {
    ...
    arxiv: 'Arxiv', allSpec: 'Barcha mutaxassislar',
    control: 'Boshqaruv markazi', logout: 'Chiqish',
    noPost: 'Hali elon yoq', noOne: 'Hali hech kim yoq',
    noRating: 'Hali reyting yoq', noSeller: 'Hali sotuvchi yoq',
    tenant: 'Ijarachi', fullName: 'Ism familiya', nickname: 'Nik nomi',
    reply: 'Javob berish', commentsT: 'Komentariyalar',
    games: 'Oyinlar', editProfile: 'Profilni tahrirlash',
    share: 'Ulashish', saved: 'Saqlangan', stats: 'Statistika',
    aiHelper: 'AI yordamchi', notifs: 'Bildirishnomalar',
    settings: 'Sozlamalar', lang: 'Til', addPost: 'Elon qoshish',
    // Navigatsiya
  ...
  ru: {
    ...
    arxiv: 'Архив', allSpec: 'Все специалисты',
    control: 'Центр управления', logout: 'Выйти',
    noPost: 'Объявлений пока нет', noOne: 'Пока никого нет',
    noRating: 'Рейтинга пока нет', noSeller: 'Продавцов пока нет',
    tenant: 'Арендатор', fullName: 'Имя и фамилия', nickname: 'Никнейм',
    reply: 'Ответить', commentsT: 'Комментарии',
    games: 'Игры', editProfile: 'Редактировать профиль',
    share: 'Поделиться', saved: 'Сохранённые', stats: 'Статистика',
    aiHelper: 'AI помощник', notifs: 'Уведомления',
    settings: 'Настройки', lang: 'Язык', addPost: 'Добавить объявление',
  ...
  en: {
    ...
    arxiv: 'Archive', allSpec: 'All specialists',
    control: 'Control center', logout: 'Log out',
    noPost: 'No listings yet', noOne: 'Nobody here yet',
    noRating: 'No ratings yet', noSeller: 'No sellers yet',
    tenant: 'Tenant', fullName: 'Full name', nickname: 'Nickname',
    reply: 'Reply', commentsT: 'Comments',
    games: 'Games', editProfile: 'Edit profile',
    share: 'Share', saved: 'Saved', stats: 'Statistics',
    aiHelper: 'AI assistant', notifs: 'Notifications',
    settings: 'Settings', lang: 'Language', addPost: 'Add listing',
